<?php
    $url = file_get_contents('https://anitop.vercel.app/api/v1/opening-song');
...
<div id="search-results" class="container"></div>
        ...
        <hr>
        <center><h1>Opening Song</h1></center>
        <br><br><br>

        <div class="row" id="opening-song">
                ...
                <div class="card">
                    ...
                    <center>
                        ...
                        <h5 class="card-title"> Title : <?php echo $item['title']?></h5>
                            <p class="card-text"> Artist : <?php echo implode(' , ' , $item['artists'])?></p>
