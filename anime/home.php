<?php
    $url = file_get_contents('https://anitop.vercel.app/api/v1/top-anime');
...
<div id="search-results" class="container"></div>
        <hr>
        <center><h1>Top Anime</h1></center>
        <br><br><br>

        <div class="row" id="top-anime">
                ...
                <div class="card">
                    ...
                    <center>
                        ...
                        <h5 class="card-title"> Title : <?php echo $item['title']?></h5>
                            <p class="card-text"> Studio : <?php echo $item['studio']?></p>
