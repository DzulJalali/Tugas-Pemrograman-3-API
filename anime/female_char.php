<?php
    $url = file_get_contents('https://anitop.vercel.app/api/v1/female-character');
...
<div id="search-results" class="container"></div>
        ...
        <hr>
        <center><h1>Female Character</h1></center>
        <br><br><br>

        <div class="row" id="female-character">
            <div class="row justify-content-center">
                ...
                <div class="card">
                    <div class="col-md-12">
                    <center>
                        <img src="<?php echo $item['imageUrl']?>" class="rounded" width="800" height="350" alt="">
                        <div class="card-body">
                        <h5 class="card-title"> Name : <?php echo $item['name']?></h5>
